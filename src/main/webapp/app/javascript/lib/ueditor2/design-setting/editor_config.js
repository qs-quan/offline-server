       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[
            ['source', '|', 'undo', 'redo', '|',
                ...
                'insertfunction','cutsubtable','pastesubtable','customquery','uncustomquery','numbervalidate','pictureshowcontrol','processinstance','help']
        ]
        ...
        ,iframeCssUrl: __ctx +"/styles/green/css/form.css" //给编辑器内部引入一个css文件
