...
(function () {
    ...
    var scriptEls = document.getElementsByTagName('script'),
        ...
        debug = getQueryParam('debug'),
        theme = getQueryParam('theme') || 'gray',//neptune gray
    ...
    document.write('<script type="text/javascript" src="' + path + '/ext-all' + (debug ? '-debug-w-comments' : '') + (rtl ? '-rtl' : '') + '.js"></script>');
