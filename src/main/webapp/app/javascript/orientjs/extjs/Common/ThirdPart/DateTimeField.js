 ...
 * @author
 */
Ext.define('OrientTdm.Common.ThirdPart.DateTimeField', {
    extend:'Ext.form.field.Date',
    alias: 'widget.datetimefield',
    requires: ['OrientTdm.Common.ThirdPart.DateTimePicker'],
    ...
    createPicker: function() {
        ...
        return new OrientTdm.Common.ThirdPart.DateTimePicker({
            pickerField: me,
            ownerCt: me.ownerCt,
