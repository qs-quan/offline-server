 ...
 * 删除模型数据
 */
Ext.define("OrientTdm.Common.Extend.Button.Override.DeleteModelDataButton", {
                ...
                if (btn == 'yes') {
                    ...
                    Ext.Ajax.request({
                        ...
                        success: function (response) {
                            ...
                            if(modelGridPanel.customSuccessCallBack != undefined){
                                modelGridPanel.customSuccessCallBack();
                            }
