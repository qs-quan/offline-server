 ...
 * 启动试验项目
 */
Ext.define('OrientTdm.Example.BtnExtend.StartTestPrj', {
    extend: 'OrientTdm.Common.Extend.Button.OrientButton',
    alias: 'widget.startTestPrj',
    triggerClicked: function (modelGridPanel) {
        ...
        if (selections.length === 0) {
            ...
            if (me.btnDesc) {
                ...
                OrientExtUtil.AjaxHelper.doRequest(serviceName + '/customExampleController/startTestPrj.rdm', params, true, function (resp) {
