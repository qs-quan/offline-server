 ...
 */
Ext.define('OrientTdm.HomePage.Portal.PortalDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function (portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        OrientTdm.HomePage.Portal.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function () {
        ...
        OrientTdm.HomePage.Portal.PortalDropZone.superclass.unreg.call(this);
    }
});
