 ...
 */
Ext.define('OrientTdm.Collab.MyTask.Calendar.form.field.DateRange', {
    extend: 'Ext.form.FieldContainer',
    alias: 'widget.orientdaterangefield',
     ...
     */
    getValue: function(){
        var eDate = OrientTdm.Collab.MyTask.Calendar.util.Date,
     ...
     * as defined in {@link OrientTdm.Collab.MyTask.Calendar.data.EventMappings}.</div></li><ul></div>
     */
    setValue: function(v){
        if(!v) {
            return;
        ...
        else if(v[OrientTdm.Collab.MyTask.Calendar.data.EventMappings.StartDate.name]){ //object
            this.setDT(v[OrientTdm.Collab.MyTask.Calendar.data.EventMappings.StartDate.name], 'start');
            if(!this.setDT(v[OrientTdm.Collab.MyTask.Calendar.data.EventMappings.EndDate.name], 'end')){
                this.setDT(v[OrientTdm.Collab.MyTask.Calendar.data.EventMappings.StartDate.name], 'end');
            }
            this.allDay.setValue(!!v[OrientTdm.Collab.MyTask.Calendar.data.EventMappings.IsAllDay.name]);
        }
    },
