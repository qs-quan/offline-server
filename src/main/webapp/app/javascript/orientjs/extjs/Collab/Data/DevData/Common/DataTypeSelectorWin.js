 ...
 */
Ext.define('OrientTdm.Collab.Data.DevData.Common.DataTypeSelectorWin', {
        extend: 'Ext.window.Window',
        alias: 'widget.dataTypeSelectorWin',
        config: {
            bindRecord: null,
        ...
        initComponent: function () {
            var me = this;
            var dataTypeTree = me._createDataTypeTree();
            Ext.apply(me, {
                plain: true,
                height: 600,
                width: 200,
        ...
        _createDataTypeTree: function () {
            ...
            var store = Ext.create('Ext.data.TreeStore', {
                ...
                proxy: {
                    type: 'ajax',
                    api: {
                        "read": serviceName + '/DataType/getAllDataTypes.rdm'
                    },
                    reader: {
                        type: 'json',
        ...
        _saveSelected: function () {
            ...
            if (records.length == 0) {
                ...
                me.bindRecord.set('datatypeId', records[0].raw['dataTypeId']);
                me.bindRecord.set('dataTypeShowName', records[0].raw['text']);
                me.bindRecord.set('extendsTypeRealName', records[0].raw['dataType']);
                me.bindRecord.set('isref', records[0].raw['isref']);
                me.bindRecord.set('value', records[0].raw['value']);
            }
            if (me.afterSelected) {
                me.afterSelected.call(me);
                me.close();
            }
        }
    }
