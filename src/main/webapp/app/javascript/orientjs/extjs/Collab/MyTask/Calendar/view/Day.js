/**
 * @class OrientTdm.Collab.MyTask.Calendar.view.Day
 * @extends Ext.container.Container
 * <p>Unlike other calendar views, is not actually a subclass of {@link OrientTdm.Collab.MyTask.Calendar.view.AbstractCalendar AbstractCalendar}.
 * Instead it is a {@link Ext.container.Container Container} subclass that internally creates and manages the layouts of
 * a {@link OrientTdm.Collab.MyTask.Calendar.DayHeaderView DayHeaderView} and a {@link OrientTdm.Collab.MyTask.Calendar.DayBodyView DayBodyView}. As such
 ...
 */
Ext.define('OrientTdm.Collab.MyTask.Calendar.view.Day', {
    extend: 'Ext.container.Container',
    alias: 'widget.orientdayview',
    
    requires: [
        'OrientTdm.Collab.MyTask.Calendar.view.AbstractCalendar',
        'OrientTdm.Collab.MyTask.Calendar.view.DayHeader',
        'OrientTdm.Collab.MyTask.Calendar.view.DayBody'
    ],
    ...
    initComponent : function(){
        ...
        var header = Ext.applyIf({
            xtype: 'orientdayheaderview',
            id: this.id+'-hd'
        }, cfg);
        
        var body = Ext.applyIf({
            xtype: 'orientdaybodyview',
            id: this.id+'-bd'
        }, cfg);
