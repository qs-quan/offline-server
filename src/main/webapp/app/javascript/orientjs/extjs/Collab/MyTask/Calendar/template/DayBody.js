/**
 * @class OrientTdm.Collab.MyTask.Calendar.template.DayBody
 * @extends Ext.XTemplate
 * <p>This is the template used to render the scrolling body container used in {@link OrientTdm.Collab.MyTask.Calendar.DayView DayView} and
 * {@link OrientTdm.Collab.MyTask.Calendar.WeekView WeekView}. This template is automatically bound to the underlying event store by the
 ...
 * that internally creates an instance of this template along with a {@link OrientTdm.Collab.MyTask.Calendar.DayHeaderTemplate}.</p>
 * @constructor
 * @param {Object} config The config object
 */
Ext.define('OrientTdm.Collab.MyTask.Calendar.template.DayBody', {
    ...
    applyTemplate : function(o){
        this.today = OrientTdm.Collab.MyTask.Calendar.util.Date.today();
        ...
        for(; i<this.dayCount; i++){
            days[i] = OrientTdm.Collab.MyTask.Calendar.util.Date.add(dt, {days: i});
        }
        ...
        for(i=0; i<24; i++){
            ...
            dt = OrientTdm.Collab.MyTask.Calendar.util.Date.add(dt, {hours: 1});
        }
