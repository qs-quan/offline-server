/**
 * @class OrientTdm.Collab.MyTask.Calendar.view.DayHeader
 * @extends OrientTdm.Collab.MyTask.Calendar.orientmonthview
 ...
 * which aggregates this class and the {@link OrientTdm.Collab.MyTask.Calendar.DayBodyView DayBodyView} into the single unified view
 * presented by {@link OrientTdm.Collab.MyTask.Calendar.CalendarPanel CalendarPanel}.</p>
 * @constructor
 * @param {Object} config The config object
 */
Ext.define('OrientTdm.Collab.MyTask.Calendar.view.DayHeader', {
    extend: 'OrientTdm.Collab.MyTask.Calendar.view.Month',
    alias: 'widget.orientdayheaderview',

    requires: [
        'OrientTdm.Collab.MyTask.Calendar.template.DayHeader'
    ],
     ...
     * @param {OrientTdm.Collab.MyTask.Calendar.DayBodyView} this
    ...
    afterRender: function() {
        if (!this.tpl) {
            this.tpl = new OrientTdm.Collab.MyTask.Calendar.template.DayHeader({
                id: this.id,
