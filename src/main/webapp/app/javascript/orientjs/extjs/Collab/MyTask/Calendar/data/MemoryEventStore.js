 ...
 */
Ext.define('OrientTdm.Collab.MyTask.Calendar.data.MemoryEventStore', {
    ...
    constructor: function (config) {
        ...
        this.sorters = this.sorters || [{
                property: OrientTdm.Collab.MyTask.Calendar.data.EventMappings.StartDate.name,
                direction: 'ASC'
            }];

        this.idProperty = this.idProperty || OrientTdm.Collab.MyTask.Calendar.data.EventMappings.EventId.mapping || 'id';
        this.fields = OrientTdm.Collab.MyTask.Calendar.data.EventModel.prototype.fields.getRange();
    ...
    interceptCreateRecords: function (records, operation, success) {
        if (success) {
            ...
            for (; i < len; i++) {
                records[i].data[OrientTdm.Collab.MyTask.Calendar.data.EventMappings.EventId.name] = records[i].id;
            }
        }
    },
