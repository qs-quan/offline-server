 ...
 */
Ext.define('OrientTdm.Collab.MyTask.Calendar.dd.DayDropZone', {
    extend: 'OrientTdm.Collab.MyTask.Calendar.dd.DropZone',
    requires: [
    ...
    onNodeOver: function(n, dd, e, data) {
        ...
        if (data.type == 'caldrag') {
            ...
            curr = OrientTdm.Collab.MyTask.Calendar.util.Date.copyTime(n.date, this.dragCreateDt);
            this.dragStartDate = OrientTdm.Collab.MyTask.Calendar.util.Date.min(this.dragCreateDt, curr);
            this.dragEndDate = endDt || OrientTdm.Collab.MyTask.Calendar.util.Date.max(this.dragCreateDt, curr);
            ...
            if (data.type == 'eventresize') {
                ...
                curr = OrientTdm.Collab.MyTask.Calendar.util.Date.copyTime(n.date, this.resizeDt);
                start = OrientTdm.Collab.MyTask.Calendar.util.Date.min(data.eventStart, curr);
                end = OrientTdm.Collab.MyTask.Calendar.util.Date.max(data.eventStart, curr);
