 ...
 */
Ext.define('OrientTdm.Collab.MyTask.Calendar.dd.DropZone', {
    ...
    onNodeDrop: function(n, dd, e, data) {
        if (n && data) {
            if (data.type == 'eventdrag') {
                ...
                dt = OrientTdm.Collab.MyTask.Calendar.util.Date.copyTime(rec.data[OrientTdm.Collab.MyTask.Calendar.data.EventMappings.StartDate.name], n.date);
