/**
 * @class OrientTdm.Collab.MyTask.Calendar.view.Month
 * @extends OrientTdm.Collab.MyTask.Calendar.CalendarView
 ...
 */
Ext.define('OrientTdm.Collab.MyTask.Calendar.view.Month', {
    extend: 'OrientTdm.Collab.MyTask.Calendar.view.AbstractCalendar',
    alias: 'widget.orientmonthview',
    
    requires: [
        'OrientTdm.Collab.MyTask.Calendar.template.Month',
        'OrientTdm.Collab.MyTask.Calendar.util.WeekEventRenderer',
        'OrientTdm.Collab.MyTask.Calendar.view.MonthDayDetail'
    ],
     ...
     * True to display an extra column before the first day in the calendar that links to the {@link OrientTdm.Collab.MyTask.Calendar.WeekView view}
    ...
    initComponent: function() {
        ...
        this.addEvents({
             ...
             * @param {OrientTdm.Collab.MyTask.Calendar.view.Month} this
             * @param {Date} dt The date/time that was clicked on
             * @param {Boolean} allday True if the day clicked on represents an all-day box, else false. Clicks within the 
             * orientmonthview always return true for this param.
    ...
    initDD: function() {
        ...
        this.dragZone = new OrientTdm.Collab.MyTask.Calendar.dd.DragZone(this.el, cfg);
        this.dropZone = new OrientTdm.Collab.MyTask.Calendar.dd.DropZone(this.el, cfg);
    },
    ...
    afterRender: function() {
        if (!this.tpl) {
            this.tpl = new OrientTdm.Collab.MyTask.Calendar.template.Month({
                id: this.id,
    ...
    getTemplateEventData: function(evt) {
        ...
        return Ext.applyIf({
            ...
            _colorCls: 'ext-color-' + (evt[M.TaskTypeId.name] ?
            evt[M.TaskTypeId.name] : 'default') + (evt._renderAsAllDay ? '-ad': ''),
    ...
    renderItems: function() {
        OrientTdm.Collab.MyTask.Calendar.util.WeekEventRenderer.render({
    ...
    getDayAt: function(x, y) {
        var box = this.el.getBox(),
            ...
            days = (dayT * 7) + dayL,
            dt = OrientTdm.Collab.MyTask.Calendar.util.Date.add(this.viewStart, {days: days});
        return {
            date: dt,
            el: this.getDayEl(dt)
        };
    ...
    onMoreClick: function(dt) {
        if (!this.detailPanel) {
            this.detailPanel = Ext.create('Ext.Panel', {
                ...
                items: {
                    xtype: 'orientmonthdaydetailview',
    ...
    onClick: function(e, t) {
        ...
        if (OrientTdm.Collab.MyTask.Calendar.view.Month.superclass.onClick.apply(this, arguments)) {
