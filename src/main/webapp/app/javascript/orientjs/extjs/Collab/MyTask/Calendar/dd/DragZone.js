 ...
 */
Ext.define('OrientTdm.Collab.MyTask.Calendar.dd.DragZone', {
    extend: 'Ext.dd.DragZone',

    requires: [
        'OrientTdm.Collab.MyTask.Calendar.dd.StatusProxy',
    ...
    constructor: function(el, config) {
        if (!OrientTdm.Collab.MyTask.Calendar._statusProxyInstance) {
            OrientTdm.Collab.MyTask.Calendar._statusProxyInstance = new OrientTdm.Collab.MyTask.Calendar.dd.StatusProxy();
        }
        this.proxy = OrientTdm.Collab.MyTask.Calendar._statusProxyInstance;
