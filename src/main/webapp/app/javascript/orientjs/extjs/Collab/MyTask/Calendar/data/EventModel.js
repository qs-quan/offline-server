/**
 * @class OrientTdm.Collab.MyTask.Calendar.data.EventModel
 * @extends Ext.data.Record
 * <p>This is the {@link Ext.data.Record Record} specification for calendar event data used by the
 * {@link OrientTdm.Collab.MyTask.Calendar.CalendarPanel CalendarPanel}'s underlying store. It can be overridden as
...
rec = new OrientTdm.Collab.MyTask.Calendar.data.EventModel({
 ...
 * If you have overridden any of the record's data mappings via the OrientTdm.Collab.MyTask.Calendar.data.EventMappings object
 ...
 */
Ext.define('OrientTdm.Collab.MyTask.Calendar.data.EventModel', {
    ...
    statics: {
        /**
         * Reconfigures the default record definition based on the current {@link OrientTdm.Collab.MyTask.Calendar.data.EventMappings EventMappings}
         * object. See the header documentation for {@link OrientTdm.Collab.MyTask.Calendar.data.EventMappings} for complete details and
...
function(){
    OrientTdm.Collab.MyTask.Calendar.data.EventModel.reconfigure();
});