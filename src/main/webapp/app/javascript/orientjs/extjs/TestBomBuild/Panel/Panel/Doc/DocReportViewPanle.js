 ...
 * 文档在线查看、编辑
 */
Ext.define('OrientTdm.TestBomBuild.Panel.Panel.Doc.DocReportViewPanle', {
    ...
    _initDocPreview: function (reportName) {
        ...
        me.add({
            ...
            '/app/views/doctemplate/docTemplateView.jsp?reportNameFolderName=' + me.reportNameFolderName + '&isFtpHome=' + true + '&itemId=' + itemId + '&reportName=' + reportName + '"></iframe>',
            layout: 'fit',
    ...
    getReportName: function () {
        var me = this;
        return Ext.getCmp(me.modelName + me.modelId).getValue();
    },
    ...
    saveToFtpHome: function () {
        ...
        if (Ext.isEmpty(me.reportName)) {
            ...
            if (reportName) {
                ...
                var realReportName = new Date().getTime() + '_' + me.modelId + '.doc';
